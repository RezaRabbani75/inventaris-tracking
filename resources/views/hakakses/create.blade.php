    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function toggleFields() {
                // Sembunyikan semua bidang terlebih dahulu
                ...
                if (selectedRole === 'teacher') {
                    ...
                    // Bersihkan input lain agar tidak mengirimkan data lawas yang membingungkan validator
                    nikInput.value = '';
            ...
            // Jalankan fungsi saat pertama kali halaman dimuat (untuk mendukung fungsi old())
            toggleFields();
        });
    </script>
    @endpush
