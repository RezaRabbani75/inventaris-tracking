            ...
            <div class="card-body">
                <form action="{{ url('statistik') }}" method="GET" class="row align-items-end">
                    ...
                    <div class="form-group col-md-4 mb-0 mt-3 mt-md-0">
                        ...
                        <button type="submit" name="export" value="pdf" class="btn btn-danger px-3 shadow-sm" style="flex: 1;">
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        const labelsBarang = @json($chartBarangLabels ?? ['Belum Ada Data']);
        const dataBarang = @json($chartBarangData ?? [0]);
        
        const labelsUser = @json($chartUserLabels ?? ['Belum Ada Data']);
        const dataUser = @json($chartUserData ?? [0]);
